...
length.box2 <- ggplot(data = tp3, aes(y = Duration, x = Int.Type)) +
  geom_boxplot(outlier.shape = 4, size = 0.25, position = position_dodge2(preserve = "single"), alpha=0.9) +
  geom_point(aes(color = Outlier), position = position_dodge2(width = 0.1), size = 1) +
  labs(y = "Interaction Duration (s)", x = "Relationship") +
  scale_color_manual(values = c("black", "white")) +
  theme_classic() +
  theme(legend.position = "none",
...
#Save figure
ggsave("Figures/Figure2_DearEnemy.png", plot = dee.p,
...
ggsave("Figures/Figure3_DearEnemy.png", plot = IV.spv.floaters2,
