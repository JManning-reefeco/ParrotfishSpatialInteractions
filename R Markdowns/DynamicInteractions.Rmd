...
write.table(dyn.tr.sum.all, file = "DataSummary/dyn.tr.sum.all.txt",
...
write.table(dyn.mkde.sum, file = "DataSummary/dynamic.HR.txt",
            sep = ",", quote = FALSE, row.names = F)
```
...
ggsave("Figures/PseudoDI.png", plot = DI.p,
...
write.table(staticdynamic, "DataSummary/StaticDynamic.txt", 
            sep = ",", quote = FALSE, row.names = F)
...
# animate frames
animate_frames(frames.Inter.04.f, out_file = "Figures/InterspecificDynamicInteractions.gif", overwrite = T)
```
